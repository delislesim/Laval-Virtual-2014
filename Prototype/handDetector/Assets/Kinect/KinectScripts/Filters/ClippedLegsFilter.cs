...
public class ClippedLegsFilter
{
    ...
    private Wrapper.NuiSkeletonData filteredSkeleton;
    ...
    public ClippedLegsFilter()
    {
        ...
        this.filteredSkeleton = new Wrapper.NuiSkeletonData();
    ...
    public bool FilterSkeleton(ref Wrapper.NuiSkeletonData skeleton, float deltaNuiTime)
    {
//        if (null == skeleton)
//        {
//            return false;
//        }
        ...
        if (skeleton.eTrackingState != Wrapper.NuiSkeletonTrackingState.SkeletonTracked)
        {
            filterJoints.Reset();
        }
        ...
        if ((!KinectHelper.IsTracked(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.HipCenter)) || 
			(!KinectHelper.IsTrackedOrInferred(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.HipLeft)) || 
			(!KinectHelper.IsTrackedOrInferred(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.HipRight)))
        {
            return false;
        }

        // Determine if the skeleton is clipped by the bottom of the FOV.
        bool clippedBottom = (skeleton.dwQualityFlags & (int)Wrapper.FrameEdges.Bottom) != 0;
        ...
        if (!KinectHelper.IsTracked(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.KneeLeft))
        {
            leftLegMask = this.kneeInferred;
        }
        else if (!KinectHelper.IsTracked(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.AnkleLeft))
        {
            leftLegMask = this.ankleInferred;
        }
        else if (!KinectHelper.IsTracked(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.FootLeft))
        {
        ...
        if (!KinectHelper.IsTracked(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.KneeRight))
        {
            rightLegMask = this.kneeInferred;
        }
        else if (!KinectHelper.IsTracked(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.AnkleRight))
        {
            rightLegMask = this.ankleInferred;
        }
        else if (!KinectHelper.IsTracked(skeleton, (int)Wrapper.NuiSkeletonPositionIndex.FootRight))
        {
        ...
        {
			int jointIndex = (int)Wrapper.NuiSkeletonPositionIndex.KneeLeft;
            KinectHelper.LerpAndApply(ref skeleton, jointIndex, (Vector3)filteredSkeleton.SkeletonPositions[jointIndex], lerpLeftKnee.SmoothValue, Wrapper.NuiSkeletonPositionTrackingState.Tracked);
        ...
        {
			int jointIndex = (int)Wrapper.NuiSkeletonPositionIndex.AnkleLeft;
            KinectHelper.LerpAndApply(ref skeleton, jointIndex, (Vector3)filteredSkeleton.SkeletonPositions[jointIndex], lerpLeftAnkle.SmoothValue, Wrapper.NuiSkeletonPositionTrackingState.Tracked);
            skeletonUpdated = true;
        }
        ...
        {
			int jointIndex = (int)Wrapper.NuiSkeletonPositionIndex.FootLeft;
            KinectHelper.LerpAndApply(ref skeleton, jointIndex, (Vector3)filteredSkeleton.SkeletonPositions[jointIndex], lerpLeftFoot.SmoothValue, Wrapper.NuiSkeletonPositionTrackingState.Inferred);
            skeletonUpdated = true;
        }
        ...
        {
			int jointIndex = (int)Wrapper.NuiSkeletonPositionIndex.KneeRight;
            KinectHelper.LerpAndApply(ref skeleton, jointIndex, (Vector3)filteredSkeleton.SkeletonPositions[jointIndex], lerpRightKnee.SmoothValue, Wrapper.NuiSkeletonPositionTrackingState.Tracked);
            skeletonUpdated = true;
        }
        ...
        {
			int jointIndex = (int)Wrapper.NuiSkeletonPositionIndex.AnkleRight;
            KinectHelper.LerpAndApply(ref skeleton, jointIndex, (Vector3)filteredSkeleton.SkeletonPositions[jointIndex], lerpRightAnkle.SmoothValue, Wrapper.NuiSkeletonPositionTrackingState.Tracked);
            skeletonUpdated = true;
        }
        ...
        {
			int jointIndex = (int)Wrapper.NuiSkeletonPositionIndex.FootRight;
            KinectHelper.LerpAndApply(ref skeleton, jointIndex, (Vector3)filteredSkeleton.SkeletonPositions[jointIndex], lerpRightFoot.SmoothValue, Wrapper.NuiSkeletonPositionTrackingState.Inferred);
            skeletonUpdated = true;
        }
