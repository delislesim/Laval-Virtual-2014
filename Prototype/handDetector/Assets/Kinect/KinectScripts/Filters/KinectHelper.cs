...
public class KinectHelper 
{
    ...
    public static bool IsTracked(Wrapper.NuiSkeletonData skeleton, int jointIndex)
    {
//            if (null == skeleton)
//            {
//                return false;
//            }
		...
		return skeleton.eSkeletonPositionTrackingState[jointIndex] == Wrapper.NuiSkeletonPositionTrackingState.Tracked;
    }

    // IsTrackedOrInferred checks whether the skeleton joint is tracked or inferred.
    public static bool IsTrackedOrInferred(Wrapper.NuiSkeletonData skeleton, int jointIndex)
    {
//            if (null == skeleton)
//            {
//                return false;
//            }
		...
		return skeleton.eSkeletonPositionTrackingState[jointIndex] != Wrapper.NuiSkeletonPositionTrackingState.NotTracked;
    }
    ...
    public static void LerpAndApply(ref Wrapper.NuiSkeletonData skeleton, int jointIndex, Vector3 newJointPos, float lerpValue, Wrapper.NuiSkeletonPositionTrackingState finalTrackingState)
    {
//            if (null == skeleton)
//            {
//                return;
//            }
    ...
    public static void CopySkeleton(ref Wrapper.NuiSkeletonData source, ref Wrapper.NuiSkeletonData destination)
    {
//        if (null == source)
//        {
//            return;
...
//        }
		...
		if(destination.eSkeletonPositionTrackingState == null)
			destination.eSkeletonPositionTrackingState = new Wrapper.NuiSkeletonPositionTrackingState[jointsCount];
    ...
    public static Vector3 VectorBetween(ref Wrapper.NuiSkeletonData skeleton, int startJoint, int endJoint)
    {
//        if (null == skeleton)
//        {
//            return Vector3.Zero;
