...
public class BoneOrientationsFilter
{
    ...
    {
        this.smoothParameters = new Wrapper.NuiTransformSmoothParameters();
    ...
    public void Init(Wrapper.NuiTransformSmoothParameters smoothingParameters)
    {
    ...
    public void Reset()
    {
        this.history = new FilterDoubleExponentialData[(int)Wrapper.NuiSkeletonPositionIndex.Count];
    }

    // Implements a double exponential smoothing filter on the skeleton bone orientation quaternions.
    public void UpdateFilter(ref Wrapper.NuiSkeletonData skeleton, ref Matrix4x4[] jointOrientations)
    {
//        if (null == skeleton)
//        {
//            return;
...
//        }
        ...
        Wrapper.NuiTransformSmoothParameters tempSmoothingParams = new Wrapper.NuiTransformSmoothParameters();
        ...
        for(int jointIndex = 0; jointIndex < jointsCount; jointIndex++)
        {
            ...
            if (skeleton.eSkeletonPositionTrackingState[jointIndex] != Wrapper.NuiSkeletonPositionTrackingState.Tracked || 
				jointIndex == (int)Wrapper.NuiSkeletonPositionIndex.FootLeft || jointIndex == (int)Wrapper.NuiSkeletonPositionIndex.FootRight)
            {
    ...
    protected void FilterJoint(ref Wrapper.NuiSkeletonData skeleton, int jointIndex, ref Wrapper.NuiTransformSmoothParameters smoothingParameters, ref Matrix4x4[] jointOrientations)
    {
//        if (null == skeleton)
//        {
//            return;
