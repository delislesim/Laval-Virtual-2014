...
public class JointPositionsFilter
{
    ...
    public void UpdateFilter(ref Wrapper.NuiSkeletonData skeleton)
    {
//        if (null == skeleton)
//        {
//            return;
//        }
    ...
    protected void FilterJoint(ref Wrapper.NuiSkeletonData skeleton, int jointIndex, ref Wrapper.NuiTransformSmoothParameters smoothingParameters)
    {
//        if (null == skeleton)
//        {
//            return;
