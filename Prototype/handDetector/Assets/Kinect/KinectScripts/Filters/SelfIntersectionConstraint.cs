...
public class SelfIntersectionConstraint
{
    ...
    public void Constrain(ref Wrapper.NuiSkeletonData skeleton)
    {
//        if (null == skeleton)
//        {
//            return;
//        }
		...
		int shoulderCenterIndex = (int)Wrapper.NuiSkeletonPositionIndex.ShoulderCenter;
		int hipCenterIndex = (int)Wrapper.NuiSkeletonPositionIndex.HipCenter;

        if (skeleton.eSkeletonPositionTrackingState[shoulderCenterIndex] != Wrapper.NuiSkeletonPositionTrackingState.NotTracked &&
            skeleton.eSkeletonPositionTrackingState[hipCenterIndex] != Wrapper.NuiSkeletonPositionTrackingState.NotTracked)
        {
            Vector3 shoulderDiffLeft = KinectHelper.VectorBetween(ref skeleton, shoulderCenterIndex, (int)Wrapper.NuiSkeletonPositionIndex.ShoulderLeft);
            Vector3 shoulderDiffRight = KinectHelper.VectorBetween(ref skeleton, shoulderCenterIndex, (int)Wrapper.NuiSkeletonPositionIndex.ShoulderRight);
			...
			{ 
				(int)Wrapper.NuiSkeletonPositionIndex.WristLeft, 
				(int)Wrapper.NuiSkeletonPositionIndex.HandLeft, 
				(int)Wrapper.NuiSkeletonPositionIndex.WristRight, 
				(int)Wrapper.NuiSkeletonPositionIndex.HandRight 
			};
