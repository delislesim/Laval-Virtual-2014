...
public class PianoBuilder : MonoBehaviour, Instrument {
	...
	void Start () {
		// Créer le piano.
		CreerBlanche (-7, clips [2], 1);  // Do
		CreerNoire   (-7, clips [2], 2);  // Do#
		CreerBlanche (-6, clips [3], 0);  // Re
		CreerNoire   (-6, clips [3], 1);  // Re#
		CreerBlanche (-5, clips [3], 2);  // Mi
		CreerBlanche (-4, clips [3], 3);  // Fa
		CreerNoire   (-4, clips [4], 0);  // Fa#
		CreerBlanche (-3, clips [4], 1);  // Sol
		CreerNoire   (-3, clips [4], 2);  // Sol#
		CreerBlanche (-2, clips [5], 0);  // La
		CreerNoire   (-2, clips [5], 1);  // La#
		CreerBlanche (-1, clips [5], 2);  // Si

		CreerBlanche (0,  clips [6], -1);  // Do
		CreerNoire   (0,  clips [6], 0);   // Do#
		CreerBlanche (1,  clips [6], 1);   // Re
		CreerNoire   (1,  clips [6], 2);   // Re#
		CreerBlanche (2,  clips [7], 0);   // Mi
		CreerBlanche (3,  clips [7], 1);   // Fa
		CreerNoire   (3,  clips [7], 2);   // Fa#
		CreerBlanche (4,  clips [7], 3);   // Sol
		CreerNoire   (4,  clips [8], -1);  // Sol#
		CreerBlanche (5,  clips [8], 0);   // La
		CreerNoire   (5,  clips [8], 1);   // La#
		CreerBlanche (6,  clips [8], 2);   // Si

		CreerBlanche (7,  clips [9], -1);   // Do
		CreerNoire   (7,  clips [9], 0);   // Do#
		CreerBlanche (8,  clips [9], 1);   // Re
		CreerNoire   (8,  clips [9], 2);   // Re#
		CreerBlanche (9,  clips [10], -1); // Mi
		CreerBlanche (10, clips [10], 0);  // Fa
		CreerNoire   (10, clips [10], 1);  // Fa#
		CreerBlanche (11, clips [11], -1); // Sol
		CreerNoire   (11, clips [11], 0);   // Sol#
		CreerBlanche (12, clips [11], 1);  // La
		CreerNoire   (12, clips [11], 2);  // La#
		CreerBlanche (13, clips [11], 3);  // Si

		CreerBlanche (14, clips [12], -2);  // Do
		CreerNoire   (14, clips [12], -1); // Do#
		CreerBlanche (15, clips [12], 0); // Re
		CreerNoire   (15, clips [12],  1); // Re#
		CreerBlanche (16, clips [12], 2);  // Mi
		CreerBlanche (17, clips [13], -2);  // Fa
		CreerNoire   (17, clips [13], -1);  // Fa#
		CreerBlanche (18, clips [13], 0);  // Sol
		CreerNoire   (18, clips [13], 1);  // Sol#
		CreerBlanche (19, clips [13], 2);  // La
		CreerNoire   (19, clips [14], -1);  // La#
		CreerBlanche (20, clips [14], 0);  // Si

		CreerBlanche (21, clips [15], -2);  // Do
		CreerNoire   (21, clips [15], -1);  // Do#
		CreerBlanche (22, clips [15], 0);  // Re
		CreerNoire   (22, clips [15],  1);  // Re#
		CreerBlanche (23, clips [15],  2);  // Mi
		CreerBlanche (24, clips [14], 0);  // Fa
		CreerNoire   (24, clips [14], 1);  // Fa#
		CreerBlanche (25, clips [14], -1);  // Sol
		CreerNoire   (25, clips [14], 0);  // Sol#
		CreerBlanche (26, clips [14], 1);  // La
		CreerNoire   (26, clips [14], 2);  // La#
		CreerBlanche (27, clips [14], 3);  // Si
